...
const Book = () => {
  return (
    ...
    <div className='flex flex-col justify-center items-center'>
      <h1 className=" text-3xl md:text-7xl xl:text-6xl 2xl:text-8xl md:tracking-wide text-[#D31010] text-shadow-white text-center font-bold pt-20 ">AMARA LA MUÑECA POSEIDA: <span className="text-[#D31010] text-shadow-white">LA BUSQUEDA</span></h1>
